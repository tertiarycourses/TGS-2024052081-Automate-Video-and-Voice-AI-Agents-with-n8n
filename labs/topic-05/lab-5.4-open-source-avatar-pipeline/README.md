# Lab 5.4 - Build the Free Local Avatar Video Pipeline
...
1. Open `lab6-opensource/README.md` and review the service architecture.
2. Start the local render service using the provided start script for your platform.
3. Import `lab6-opensource/os-news-avatar-flow.json` into n8n.
