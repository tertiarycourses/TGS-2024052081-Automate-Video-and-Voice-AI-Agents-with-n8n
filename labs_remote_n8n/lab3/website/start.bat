@echo off
REM Cook & Bake Academy - one-click launcher (Windows)
REM Double-click this file. It serves the website on http://localhost:8091
...
echo Serving Cook & Bake Academy at %URL%
